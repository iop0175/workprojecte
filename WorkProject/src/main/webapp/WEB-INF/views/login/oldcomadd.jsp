...
<link rel="stylesheet" href="/resources/css/login/oldcomadd.css">
    ...
    <body>
        <div>
            <div class="container">
                ...
                <div class="main">
                    <div class="title">인원추가</div>
                    <form action="" id="addbox" method="post">
                        <div class="insert">
                            기업명 <div class="input"><input type="text" name="comname"></div></div>
                        <div class="insert">
                           사원명<div class="input"><input type="text" name="name"></div></div>
                        <div class="insert">
                           사원번호<div class="input"><input type="text" name="empnum"></div></div>
                        <div class="insert">
                           연락처<div class="input"><input type="number" name="tel"></div></div>
                           <button id="add">승인요청</button>
                    </form>
                </div>
